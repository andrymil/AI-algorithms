...
def evaluate_bins_effect(file_path, continuous_features, bin_sizes, max_depth):
    ...
    # Plot the results
    plt.plot(bin_sizes, train_accuracies, label="Zbiór treningowy")
    plt.plot(bin_sizes, val_accuracies, label="Zbiór walidacyjny")
    plt.xlabel("Liczba przedziałów (q)")
    plt.ylabel("Dokładność")
    plt.legend()
    plt.title("Wpływ liczby przedziałów na dokładność")
    plt.show()
...
def evaluate_training_set_size_effect(X, y, training_sizes, max_depth):
    ...
    # Plot the results
    plt.plot(training_sizes, train_accuracies, label="Zbiór treningowy")
    plt.plot(training_sizes, val_accuracies, label="Zbiór walidacyjny")
    plt.xlabel("Rozmiar zbioru treningowego")
    plt.ylabel("Dokładność")
    plt.legend()
    plt.title("Wpływ rozmiaru zbioru treningowego na dokładność")
    plt.show()
